...
// ── Compute accept/decline stats from services array ──────────────────────────
              ...
              <div>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px', marginBottom: '20px' }}>
                  {[
                    ...
                    <div key={s.label} style={{ background: isDarkMode ? '#111827' : '#f8fafc', borderRadius: '8px', padding: '14px', border: `1px solid ${c.border}`, textAlign: 'center' }}>
