...
// â”€â”€â”€ Lyrics parser â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export default function StageView({ isDarkMode, songs = [], onRefresh }) {
  ...
  // â”€â”€ ProPresenter config â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Built-in presenter state â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const [selectedSong,  setSelectedSong]  = useState(null);
  const [slides,        setSlides]        = useState([]);
  const [currentSlide,  setCurrentSlide]  = useState(-1);
  const [isBlack,       setIsBlack]       = useState(false);

  // â”€â”€ Background control â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Edit lyrics modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const [editingSong, setEditingSong] = useState(null); // song object
  const [editLyrics,  setEditLyrics]  = useState('');
  const [editSaving,  setEditSaving]  = useState(false);

  // â”€â”€ Refs so broadcast() always has current values without being re-created â”€
  ...
  // â”€â”€ Subscribe to channel once (broadcaster must be subscribed to send) â”€â”€â”€â”€â”€
  useEffect(() => {
  ...
  // â”€â”€ Broadcast a slide to display + stage monitor â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Song selection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ BG control â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const applyBg = () => {
  ...
  // â”€â”€ Edit lyrics â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Open display windows â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const openDisplay = () =>
  ...
  // â”€â”€ Shared button / input style â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  const inputStyle = {
    ...
    background: isDarkMode ? '#111111' : '#f9fafb', color: c.text, fontSize: '13px', outline: 'none',
  };
  ...
  return (
    <div style={{ height: 'calc(100vh - 108px)', display: 'flex', flexDirection: 'column', background: c.bg, overflow: 'hidden' }}>
      ...
      {/* â”€â”€ Top mode toggle â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      ...
      {mode === 'propresenter' && (
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          ...
          {/* Connection bar */}
          <div style={{ padding: '10px 20px', background: isDarkMode ? '#1f1f22' : '#f8fafc', borderBottom: `1px solid ${c.border}`, display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap', flexShrink: 0 }}>
          ...
          {ppConnected && ppIP
            ...
            : <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '16px', padding: '40px', opacity: 0.6 }}>
                ...
                <div style={{ padding: '12px 20px', borderRadius: '10px', background: c.card, border: `1px solid ${c.border}`, fontSize: '12px', color: c.text, lineHeight: '1.8', textAlign: 'left' }}>
                  <strong>ProPresenter 7 â†’ Preferences â†’ Network</strong><br />
      ...
      {mode === 'builtin' && (
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          ...
          {/* â”€â”€ Main presenter layout â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>

            {/* LEFT: Song library â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
            ...
            {/* CENTER: Slide control â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
              ...
              <div style={{ padding: '8px 14px', background: c.card, borderBottom: `1px solid ${c.border}`, display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0, flexWrap: 'wrap' }}>
                ...
                <button
                  onClick={toggleBlack}
                  style={{ ...btnBase, background: isBlack ? c.danger : (isDarkMode ? '#27272a' : '#e5e7eb'), color: isBlack ? 'white' : c.text, padding: '5px 12px', fontWeight: '700' }}
                >
                  {isBlack ? 'â–  Blank' : 'â–¡ Blank Screen'}
                </button>
                {/* BG toggle */}
                <button
              ...
              {showBgBar && (
                <div style={{ padding: '10px 14px', background: isDarkMode ? '#0a0a0a' : '#f0f9ff', borderBottom: `1px solid ${c.border}`, display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0, flexWrap: 'wrap' }}>
                  {/* Type toggle */}
            ...
            {/* RIGHT: Live preview pane â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
            <div style={{ width: '260px', borderLeft: `1px solid ${c.border}`, background: c.card, display: 'flex', flexDirection: 'column', flexShrink: 0, overflow: 'hidden' }}>
              ...
              <div style={{ padding: '12px', borderBottom: `1px solid ${c.border}` }}>
                <div style={{ fontSize: '10px', fontWeight: '700', color: c.danger, marginBottom: '6px', letterSpacing: '1px' }}>â— LIVE</div>
...
// â”€â”€â”€ Slide tile â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    <div
      ...
      style={{
        ...
        background: empty ? '#000' : (isActive ? (isDarkMode ? '#1e3a5f' : '#eff6ff') : (isDarkMode ? '#111111' : '#f8fafc')),
      }}
...
// â”€â”€â”€ Preview box â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function PreviewBox({ content, isDarkMode, dim }) {
  return (
    <div style={{
      aspectRatio: '16/9', borderRadius: '6px', background: dim ? (isDarkMode ? '#111111' : '#f1f5f9') : '#000',
      ...
      {content
        ? <div style={{ color: dim ? (isDarkMode ? '#d1d5db' : '#27272a') : 'white', fontSize: '10px', textAlign: 'center', lineHeight: '1.5', whiteSpace: 'pre-line', opacity: dim ? 0.7 : 1 }}>{content}</div>
